...
MordhauEmplacementStaticBehaviors = {}

function MordhauEmplacementStaticBehaviors.Patrol(AI, Owner, Abort)
...
local Proxy = {}
local Mt = {
	__index = MordhauEmplacementStaticBehaviors,
	__newindex = function(Table, k, v)
		error("The TurretBehaviors table is read-only.", 2)
	end
}
setmetatable(Proxy, Mt)
MordhauEmplacementStaticBehaviors = Proxy
