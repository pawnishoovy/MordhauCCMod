...
function Explode(self)
	...
	self.explosion = CreateMOSRotating("FlameBarrel Explosion")
	self.flameArea = CreateMOSRotating("FlameBarrel Area")
...
function Create(self)
	self.explode = true
	self.soundFlyLoop = CreateSoundContainer("FlameBarrel FlightLoop Catapult", "Mordhau.rte");
	...
	self.explodeSound = CreateSoundContainer("FlameBarrel Flame Start Catapult", "Mordhau.rte");
