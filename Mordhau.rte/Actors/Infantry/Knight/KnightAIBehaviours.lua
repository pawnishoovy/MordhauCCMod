...
function KnightAIBehaviours.handleVoicelines(self)
	...
	if self:NumberValueExists("Catapulted") then
		...
		elseif randomChance > 50 then
			KnightAIBehaviours.createVoiceSoundEffect(self, self.voiceSounds.Rage, 6, 4);
		elseif randomChance > 25 then
			KnightAIBehaviours.createVoiceSoundEffect(self, self.voiceSounds.frustratedSerious, 6, 4);
		else
