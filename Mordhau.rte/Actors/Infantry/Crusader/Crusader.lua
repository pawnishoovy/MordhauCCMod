...
require("Actors/Infantry/Crusader/CrusaderAIBehaviours")
...
function Create(self)
	...
	-- States:
	self.MeleeAISkill = 0.9 -- Diagnosis: skill issue
	...
	Unphased = CreateSoundContainer("VO " .. self.IdentityPrimary .. " Unphased", "Mordhau.rte"),
	...
	self.movementSounds = {
	Land = CreateSoundContainer("Crusader Gear Land", "Mordhau.rte"),
	Jump = CreateSoundContainer("Crusader Gear Jump", "Mordhau.rte"),
	Crouch = CreateSoundContainer("Crusader Gear CrouchStand", "Mordhau.rte"),
	Stand = CreateSoundContainer("Crusader Gear CrouchStand", "Mordhau.rte"),
	Step = CreateSoundContainer("Crusader Gear Move", "Mordhau.rte"),
	Prone = CreateSoundContainer("Crusader Gear Move", "Mordhau.rte"),
	Crawl = CreateSoundContainer("Crusader Gear Move", "Mordhau.rte"),
	ThrowStart = CreateSoundContainer("Crusader Gear Light Move", "Mordhau.rte"),
	Throw = CreateSoundContainer("Crusader Gear Move", "Mordhau.rte"),
	AttackLight = CreateSoundContainer("Crusader Gear Light Move", "Mordhau.rte"),
	AttackMedium = CreateSoundContainer("Crusader Gear Move", "Mordhau.rte"),
	AttackLarge = CreateSoundContainer("Crusader Gear Move", "Mordhau.rte"),
	AttackExtreme = CreateSoundContainer("Crusader Gear Move", "Mordhau.rte")};
	...
	self.voiceSound = CreateSoundContainer("Crusader Gear Move", "Mordhau.rte");
...
function Update(self)
	...
	if (self.Dying ~= true) then
		...
		CrusaderAIBehaviours.handleMovement(self);
		
		CrusaderAIBehaviours.handleHealth(self);
		
		CrusaderAIBehaviours.handleSuppression(self);
		
		CrusaderAIBehaviours.handleAITargetLogic(self);
		
		CrusaderAIBehaviours.handleVoicelines(self);
		
		--CrusaderAIBehaviours.handleHeadFrames(self);

	else
	
		CrusaderAIBehaviours.handleDying(self);
	
		CrusaderAIBehaviours.handleHeadLoss(self);
	...
	if self.Status == 1 or self.Dying then
		CrusaderAIBehaviours.handleRagdoll(self)
	end
