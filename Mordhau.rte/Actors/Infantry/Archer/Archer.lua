...
require("Actors/Infantry/Archer/ArcherAIBehaviours")
...
function Create(self)
	...
	-- States:
	self.MeleeAISkill = 0.4 -- Diagnosis: skill issue
	...
	self.movementSounds = {
	Land = CreateSoundContainer("Archer Gear Land", "Mordhau.rte"),
	Jump = CreateSoundContainer("Archer Gear Jump", "Mordhau.rte"),
	Crouch = CreateSoundContainer("Archer Gear CrouchStand", "Mordhau.rte"),
	Stand = CreateSoundContainer("Archer Gear CrouchStand", "Mordhau.rte"),
	Step = CreateSoundContainer("Archer Gear Move", "Mordhau.rte"),
	Prone = CreateSoundContainer("Archer Gear Move", "Mordhau.rte"),
	Crawl = CreateSoundContainer("Archer Gear Move", "Mordhau.rte"),
	ThrowStart = CreateSoundContainer("Archer Gear Light Move", "Mordhau.rte"),
	Throw = CreateSoundContainer("Archer Gear Move", "Mordhau.rte"),
	AttackLight = CreateSoundContainer("Archer Gear Light Move", "Mordhau.rte"),
	AttackMedium = CreateSoundContainer("Archer Gear Move", "Mordhau.rte"),
	AttackLarge = CreateSoundContainer("Archer Gear Move", "Mordhau.rte"),
	AttackExtreme = CreateSoundContainer("Archer Gear Move", "Mordhau.rte")};
	...
	self.voiceSound = CreateSoundContainer("Archer Gear Move", "Mordhau.rte");
...
function Update(self)
	...
	if (self.Dying ~= true) then
		...
		ArcherAIBehaviours.handleMovement(self);
		
		ArcherAIBehaviours.handleHealth(self);
		
		ArcherAIBehaviours.handleSuppression(self);
		
		ArcherAIBehaviours.handleAITargetLogic(self);
		
		ArcherAIBehaviours.handleVoicelines(self);
		
		--ArcherAIBehaviours.handleHeadFrames(self);

	else
	
		ArcherAIBehaviours.handleDying(self);
	
		ArcherAIBehaviours.handleHeadLoss(self);
	...
	if self.Status == 1 or self.Dying then
		ArcherAIBehaviours.handleRagdoll(self)
	end
