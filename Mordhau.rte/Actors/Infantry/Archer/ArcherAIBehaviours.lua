...
function ArcherAIBehaviours.handleVoicelines(self)
	...
	if self:NumberValueExists("Mordhau Arrow Suppression") then
		...
		ArcherAIBehaviours.createVoiceSoundEffect(self, self.voiceSounds.Archers, 3, 0);
	end
	...
	if self:NumberValueExists("Blocked Mordhau") then
		...
		if self:NumberValueExists("Blocked Heavy Mordhau") then
			...
			ArcherAIBehaviours.createVoiceSoundEffect(self, self.voiceSounds.frustratedMedium, 3, 0);
		end
	end
	...
	if self:NumberValueExists("Puglism Block") then
		...
		ArcherAIBehaviours.createVoiceSoundEffect(self, self.voiceSounds.attackLight, 2, 0);
