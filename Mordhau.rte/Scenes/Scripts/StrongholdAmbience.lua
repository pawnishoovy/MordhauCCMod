function Create(self)
	...
	self.windAmbienceSound = CreateSoundContainer("Stronghold Ambience", "Mordhau.rte");
	self.windAmbienceSound:Play(Vector(0, 0));
	
	self.windInteriorAmbienceSound = CreateSoundContainer("Stronghold Interior Ambience", "Mordhau.rte");
	...
	self.ambienceDelay = 1500;
	
	self.interiorAmbienceTimer = Timer();
	self.interiorAmbienceDelay = 1449;
