function Create(self)
	...
	self.burnLoopSound = CreateSoundContainer("Firepot BurnLoop", "Mordhau.rte");
	self.burnEndSound = CreateSoundContainer("Firepot BurnEnd", "Mordhau.rte");
		...
		if fuel.Active then
			...
			if fuel.GFXTimer:IsPastSimMS(fuel.GFXDelay * (1 + math.pow(1 - strength, 2))) then
				...
				for i = 1, math.random(1,2) do
					local fx = CreateMOSParticle("Firepot Flame");
					if fx then
