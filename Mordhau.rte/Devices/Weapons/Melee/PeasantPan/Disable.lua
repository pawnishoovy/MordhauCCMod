function OnDetach(self)
	...
	self:DisableScript("Mordhau.rte/Devices/Weapons/Melee/PeasantPan/PeasantPan.lua");
...
function OnAttach(self)
	...
	self:EnableScript("Mordhau.rte/Devices/Weapons/Melee/PeasantPan/PeasantPan.lua");
