...
function Create(self)
	...
	self.blockedSound = CreateSoundContainer("Blocked Axe Mordhau", "Mordhau.rte");
	self.parrySound = CreateSoundContainer("Parry Axe Mordhau", "Mordhau.rte");
	self.heavyBlockAddSound = CreateSoundContainer("HeavyBlockAdd Axe Mordhau", "Mordhau.rte");
	
	self.blockSounds = {};
	self.blockSounds.Slash = CreateSoundContainer("Slash Block Axe Mordhau", "Mordhau.rte");
	self.blockSounds.Stab = CreateSoundContainer("Stab Block Axe Mordhau", "Mordhau.rte");
	...
	regularAttackSounds.hitDeflectSound = CreateSoundContainer("Slash Metal Axe Mordhau", "Mordhau.rte");
	
	regularAttackSounds.hitFleshSound = CreateSoundContainer("Slash Flesh Axe Mordhau", "Mordhau.rte");
	
	regularAttackSounds.hitMetalSound = CreateSoundContainer("Slash Metal Axe Mordhau", "Mordhau.rte");
	...
	stabAttackSounds.hitDeflectSound = CreateSoundContainer("Stab Metal Axe Mordhau", "Mordhau.rte");
	
	stabAttackSounds.hitFleshSound = CreateSoundContainer("Stab Flesh Axe Mordhau", "Mordhau.rte");
	
	stabAttackSounds.hitMetalSound = CreateSoundContainer("Stab Metal Axe Mordhau", "Mordhau.rte");
	...
	attackPhase[i].soundStart = CreateSoundContainer("Slash Axe Mordhau", "Mordhau.rte");
	...
	i = 1
	horseAttackPhase[i] = {}
	horseAttackPhase[i].durationMS = 170
	...
	horseAttackPhase[i].soundStart = CreateSoundContainer("Slash Axe Mordhau", "Mordhau.rte");
	...
	i = 2
	stabattackPhase[i] = {}
	stabattackPhase[i].durationMS = 70
	...
	stabattackPhase[i].soundStart = CreateSoundContainer("Stab Axe Mordhau", "Mordhau.rte");
	...
	overheadattackPhase[i].soundStart = CreateSoundContainer("Slash Axe Mordhau", "Mordhau.rte");
	...
	i = 6
	overheadattackPhase[i] = {}
	overheadattackPhase[i].durationMS = 220
	...
	overheadattackPhase[i].frameEnd = 6
	overheadattackPhase[i].angleStart = -120
	overheadattackPhase[i].angleEnd = -5
	...
	flourishPhase[i].angleStart = -5
	flourishPhase[i].angleEnd = -75
	flourishPhase[i].offsetStart = Vector(0, 0)
	flourishPhase[i].offsetEnd = Vector(-6, -5)
	
	flourishPhase[i].soundStart = CreateSoundContainer("Flourish Axe Mordhau", "Mordhau.rte");
	...
	shieldWarcryPhase[i].frameEnd = 6
	shieldWarcryPhase[i].angleStart = -70
	shieldWarcryPhase[i].angleEnd = -5
	...
	throwPhase[i].angleEnd = 100
	throwPhase[i].offsetStart = Vector(0, 0)
	throwPhase[i].offsetEnd = Vector(-5, -15)
	...
	throwPhase[i].frameStart = 6
	throwPhase[i].frameEnd = 6
	throwPhase[i].angleStart = 100
	throwPhase[i].angleEnd = 100
	throwPhase[i].offsetStart = Vector(-5, -15)
	throwPhase[i].offsetEnd = Vector(-5, -15)
		...
		if canBeBlocked and self.attackAnimationCanHit then -- Detect collision
			...
			if moCheck and moCheck ~= rte.NoMOID then
				...
				and ToMOSRotating(MO):GetStringValue("Parrying Type") == "Flourish"))) then
					...
					local woundsToAdd;
					local speedMult = math.max(1, self.Vel.Magnitude / 18); -- TODO: MAKE SURE THAT DIVIDER NUMBER SYNCS UP WITH INTENDED HORSE SPEED 
