...
function Create(self)
	...
	self.equipSound = CreateSoundContainer("PeasantClub Equip Mordhau", "Mordhau.rte");
	...
	self.bounceSound = CreateSoundContainer("PeasantClub Thrown Bounce Mordhau", "Mordhau.rte");
	...
	self.terrainSounds = {
	Impact = {[12] = CreateSoundContainer("PeasantClub Thrown Impact Concrete Mordhau", "Mordhau.rte"),
	[164] = CreateSoundContainer("PeasantClub Thrown Impact Concrete Mordhau", "Mordhau.rte"),
	[177] = CreateSoundContainer("PeasantClub Thrown Impact Concrete Mordhau", "Mordhau.rte"),
	[9] = CreateSoundContainer("PeasantClub Thrown Impact Dirt Mordhau", "Mordhau.rte"),
	[10] = CreateSoundContainer("PeasantClub Thrown Impact Dirt Mordhau", "Mordhau.rte"),
	[11] = CreateSoundContainer("PeasantClub Thrown Impact Dirt Mordhau", "Mordhau.rte"),
	[128] = CreateSoundContainer("PeasantClub Thrown Impact Dirt Mordhau", "Mordhau.rte"),
	[6] = CreateSoundContainer("PeasantClub Thrown Impact Sand Mordhau", "Mordhau.rte"),
	[8] = CreateSoundContainer("PeasantClub Thrown Impact Sand Mordhau", "Mordhau.rte"),
	...
	self.soundHitFlesh = CreateSoundContainer("Basic Melee Wood Flesh Mordhau", "Mordhau.rte");
	self.soundHitMetal = CreateSoundContainer("Basic Melee Wood Metal Mordhau", "Mordhau.rte");
	...
	[12] = CreateSoundContainer("PeasantClub Thrown Impact Concrete Mordhau", "Mordhau.rte"),
	[164] = CreateSoundContainer("PeasantClub Thrown Impact Concrete Mordhau", "Mordhau.rte"),
	[177] = CreateSoundContainer("PeasantClub Thrown Impact Concrete Mordhau", "Mordhau.rte"),
	[9] = CreateSoundContainer("PeasantClub Thrown Impact Dirt Mordhau", "Mordhau.rte"),
	[10] = CreateSoundContainer("PeasantClub Thrown Impact Dirt Mordhau", "Mordhau.rte"),
	...
	self.blockedSound = CreateSoundContainer("Basic Melee Wood Blocked Mordhau", "Mordhau.rte");
	...
	regularAttackSounds.hitDeflectSound = CreateSoundContainer("Basic Melee Wood Metal Mordhau", "Mordhau.rte");
	
	regularAttackSounds.hitFleshSound = CreateSoundContainer("PeasantClub Impact Flesh Mordhau", "Mordhau.rte");
	
	regularAttackSounds.hitMetalSound = CreateSoundContainer("Basic Melee Wood Metal Mordhau", "Mordhau.rte");
	...
	stabAttackSounds.hitDeflectSound = CreateSoundContainer("Basic Melee Wood Metal Mordhau", "Mordhau.rte");
	
	stabAttackSounds.hitFleshSound = CreateSoundContainer("Basic Melee Wood Flesh Mordhau", "Mordhau.rte");
	
	stabAttackSounds.hitMetalSound = CreateSoundContainer("Basic Melee Wood Metal Mordhau", "Mordhau.rte");
	...
	stabAttackPhase[i].canDamage = false
	stabAttackPhase[i].attackDamage = 2.8
		...
		if self.attackAnimationIsPlaying and currentAttackAnimation ~= 0 then -- play the animation
			...
			if not self.currentAttackStart then -- Start of the sequence
				...
				if currentPhase.soundStart then
					currentPhase.soundStart.Pitch = self.wasCharged and 0.7 or 0.8;
			...
			if self.partiallyRecovered == true and (self.moveBuffered) then
				...
				elseif self.attackAnimationBuffered == 3 then
					self:SetNumberValue("Current Attack Type", 4);
					self:SetNumberValue("Current Attack Range", self:GetNumberValue("Attack 4 Range"));
				elseif self.attackAnimationBuffered == 5 then
					self.parent:SetNumberValue("Block Foley", 1);
				elseif self.attackAnimationBuffered == 4 then
					self.parent:SetNumberValue("Block Foley", 1);
				elseif self.attackAnimationBuffered == 6 then
					self.parent:SetNumberValue("Block Foley", 1);
					self.Throwing = true;
				end
			...
			if keyPressed and not (self.attackAnimationIsPlaying) then
				...
				self.rotationInterpolationSpeed = 4
