...
function Create(self)
	...
	i = 4
	horseAttackPhase[i] = {}
	horseAttackPhase[i].durationMS = 140
	...
	horseAttackPhase[i].soundStart = CreateSoundContainer("Slash Greatsword Mordhau", "Mordhau.rte");
	...
	i = 5
	horseAttackPhase[i] = {}
	horseAttackPhase[i].durationMS = 40
	...
	i = 6
	horseAttackPhase[i] = {}
	horseAttackPhase[i].durationMS = 210
		...
		if self.attackAnimationIsPlaying and currentAttackAnimation ~= 0 then -- play the animation
			...
			if self.attackAnimationTimer:IsPastSimMS(workingDuration) then
				if (self.currentAttackSequence+1) <= #attackPhases then
					...
					if not self.moveBuffered == true and not self.stabBuffered and not self.overheadBuffered then
