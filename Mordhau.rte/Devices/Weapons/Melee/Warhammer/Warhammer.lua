...
function Create(self)
	...
	self.blockedSound = CreateSoundContainer("Blocked Warhammer Mordhau", "Mordhau.rte");
	self.parrySound = CreateSoundContainer("Parry Warhammer Mordhau", "Mordhau.rte");
	self.heavyBlockAddSound = CreateSoundContainer("HeavyBlockAdd Warhammer Mordhau", "Mordhau.rte");
	
	self.blockSounds = {};
	self.blockSounds.Slash = CreateSoundContainer("Slash Block Warhammer Mordhau", "Mordhau.rte");
	...
	attackPhase[i].soundStart = CreateSoundContainer("Slash Warhammer Mordhau", "Mordhau.rte");
	...
	horseAttackPhase[i].soundStart = CreateSoundContainer("Slash Warhammer Mordhau", "Mordhau.rte");
	...
	stabAttackPhase[i].soundStart = CreateSoundContainer("Stab Warhammer Mordhau", "Mordhau.rte");
	...
	overheadAttackPhase[i].soundStart = CreateSoundContainer("Slash Warhammer Mordhau", "Mordhau.rte");
	...
	flourishPhase[i].soundStart = CreateSoundContainer("Flourish Warhammer Mordhau", "Mordhau.rte");
