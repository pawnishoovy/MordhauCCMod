function OnDetach(self)
	...
	self:DisableScript("Mordhau.rte/Devices/Weapons/Melee/PeasantFork/PeasantFork.lua");
...
function OnAttach(self)
	...
	self:EnableScript("Mordhau.rte/Devices/Weapons/Melee/PeasantFork/PeasantFork.lua");
