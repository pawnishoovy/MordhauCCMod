function OnDetach(self)
	...
	self:DisableScript("Mordhau.rte/Devices/Weapons/Melee/PeasantShovel/PeasantShovel.lua");
...
function OnAttach(self)
	...
	self:EnableScript("Mordhau.rte/Devices/Weapons/Melee/PeasantShovel/PeasantShovel.lua");
