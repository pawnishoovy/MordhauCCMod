...
function Create(self)
	...
	stabAttackSounds.hitFleshSound = CreateSoundContainer("Basic Melee Metal Flesh Mordhau", "Mordhau.rte");
	...
	horseAttackPhase[i].soundStart = CreateSoundContainer("Basic Melee Slash Mordhau", "Mordhau.rte");
	...
	overheadattackPhase[i].canDamage = false
	overheadattackPhase[i].attackDamage = 2.2
