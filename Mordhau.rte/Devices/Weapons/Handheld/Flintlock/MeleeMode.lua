...
function Create(self)
	...
	self.soundHitFlesh = CreateSoundContainer("Slash Flesh Flintlock Mordhau", "Mordhau.rte");
	self.soundHitMetal = CreateSoundContainer("Slash Metal Flintlock Mordhau", "Mordhau.rte");
	...
	self.blockSounds.Stab = CreateSoundContainer("Stab Block Flintlock Mordhau", "Mordhau.rte");
	...
	regularAttackSounds.hitDeflectSound = CreateSoundContainer("Slash Metal Flintlock Mordhau", "Mordhau.rte");
	
	regularAttackSounds.hitFleshSound = CreateSoundContainer("Slash Flesh Flintlock Mordhau", "Mordhau.rte");
	
	regularAttackSounds.hitMetalSound = CreateSoundContainer("Slash Metal Flintlock Mordhau", "Mordhau.rte");
	...
	stabAttackSounds.hitDeflectSound = CreateSoundContainer("Stab Metal Flintlock Mordhau", "Mordhau.rte");
	
	stabAttackSounds.hitFleshSound = CreateSoundContainer("Stab Flesh Flintlock Mordhau", "Mordhau.rte");
	
	stabAttackSounds.hitMetalSound = CreateSoundContainer("Stab Metal Flintlock Mordhau", "Mordhau.rte");
	...
	i = 1
	shoveAttackPhase[i] = {}
	shoveAttackPhase[i].durationMS = 200
	...
	shoveAttackPhase[i].soundStart = CreateSoundContainer("Stab Flintlock Mordhau", "Mordhau.rte");
	...
	i = 6
	shoveAttackPhase[i] = {}
	shoveAttackPhase[i].durationMS = 90
	...
	stabAttackPhase[i].attackRange = 25
	stabAttackPhase[i].attackPush = 0.4
	stabAttackPhase[i].attackVector = Vector(7, 0) -- local space vector relative to position and rotation
	...
	stabAttackPhase[i].soundStart = CreateSoundContainer("Stab Flintlock Mordhau", "Mordhau.rte");
	...
	overheadAttackPhase[i].angleEnd = 26
	...
	overheadAttackPhase[i].canDamage = false
	overheadAttackPhase[i].attackDamage = 3
	overheadAttackPhase[i].attackStunChance = 0.3
	overheadAttackPhase[i].attackRange = 25
	overheadAttackPhase[i].attackPush = 0.8
	overheadAttackPhase[i].attackVector = Vector(8, 0) -- local space vector relative to position and rotation
	overheadAttackPhase[i].attackAngle = -235;
	
	overheadAttackPhase[i].frameStart = 1
	overheadAttackPhase[i].frameEnd = 1
	overheadAttackPhase[i].angleStart = 26
	overheadAttackPhase[i].angleEnd = -40
	overheadAttackPhase[i].offsetStart = Vector(0, -15)
	overheadAttackPhase[i].offsetEnd = Vector(6, -10)
	
	overheadAttackPhase[i].soundStart = CreateSoundContainer("Slash Flintlock Mordhau", "Mordhau.rte");
	...
	overheadAttackPhase[i].frameStart = 1
	overheadAttackPhase[i].frameEnd = 1
	overheadAttackPhase[i].angleStart = -40
	...
	flourishPhase[i].frameStart = 1
	flourishPhase[i].frameEnd = 1
	flourishPhase[i].angleStart = -115
	flourishPhase[i].angleEnd = -80
	flourishPhase[i].offsetStart = Vector(0, 0)
	flourishPhase[i].offsetEnd = Vector(-6, -5)
	
	flourishPhase[i].soundStart = CreateSoundContainer("Flourish Flintlock Mordhau", "Mordhau.rte");
	...
	warcryPhase[i].frameStart = 1
	warcryPhase[i].frameEnd = 1
	warcryPhase[i].angleStart = -115
	warcryPhase[i].angleEnd = -130
	warcryPhase[i].offsetStart = Vector(0, 5)
	warcryPhase[i].offsetEnd = Vector(-3, 7)
	...
	warcryPhase[i].frameStart = 1
	warcryPhase[i].frameEnd = 1
	warcryPhase[i].angleStart = -130
	warcryPhase[i].angleEnd = -130
	warcryPhase[i].offsetStart = Vector(-3, 7)
	warcryPhase[i].offsetEnd = Vector(-3, 7)
