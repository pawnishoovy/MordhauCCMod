...
function Create(self)
	...
	self.preSound = CreateSoundContainer("Pre Flintlock", "Mordhau.rte");
	
	self.noiseOutdoorsSound = CreateSoundContainer("NoiseOutdoors Flintlock", "Mordhau.rte");
	
	self.noiseIndoorsSound = CreateSoundContainer("NoiseIndoors Flintlock", "Mordhau.rte");
	
	self.cockSound = CreateSoundContainer("Cock Flintlock", "Mordhau.rte");
	
	self.paperRipSound = CreateSoundContainer("PaperRip Flintlock", "Mordhau.rte");
	
	self.powderTapSound = CreateSoundContainer("PowderTap Flintlock", "Mordhau.rte");

	self.powderPourSound = CreateSoundContainer("PowderPour Flintlock", "Mordhau.rte");
	
	self.paperInsertSound = CreateSoundContainer("PaperInsert Flintlock", "Mordhau.rte");
	
	self.ramRodTakeSound = CreateSoundContainer("RamRodTake Flintlock", "Mordhau.rte");
	
	self.ramRodInsertSound = CreateSoundContainer("RamRodInsert Flintlock", "Mordhau.rte");
	
	self.ramRodRamSound = CreateSoundContainer("RamRodRam Flintlock", "Mordhau.rte");
	
	self.ramRodRemoveSound = CreateSoundContainer("RamRodRemove Flintlock", "Mordhau.rte");
	...
	self.cockPrepareDelay = 1000;
	self.cockAfterDelay = 550;
	self.paperRipPrepareDelay = 550;
	self.paperRipAfterDelay = 300;
	self.powderTapPrepareDelay = 300;
	self.powderTapAfterDelay = 550;
	self.powderPourPrepareDelay = 800;
	self.powderPourAfterDelay = 550;
	self.paperInsertPrepareDelay = 500;
	self.paperInsertAfterDelay = 550;
	self.ramRodTakePrepareDelay = 400;
	self.ramRodTakeAfterDelay = 450;
	self.ramRodInsertPrepareDelay = 450;
	self.ramRodInsertAfterDelay = 350;
	self.ramRodRamPrepareDelay = 300;
	self.ramRodRamAfterDelay = 300;
	self.ramRodRam2PrepareDelay = 300;
	self.ramRodRam2AfterDelay = 450;
	self.ramRodRemovePrepareDelay = 450;
	self.ramRodRemoveAfterDelay = 700;
	self.ramRodReplacePrepareDelay = 650;
	self.ramRodReplaceAfterDelay = 700;
